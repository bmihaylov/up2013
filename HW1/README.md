...
2. Напишете програма, която чете от конзолата две цели положителни числа (a, b)
и в зависимост от остатъка при делението на b и 3 отпечатва следното:
...
3. Да се напише булев израз, който има стойност истина <=> посоченото условие е   
   истина:
  ...
  изпишете, например дали точката принадлежи на дадената фигура и т.н. . 
  Пример:      
  ...
  ```   
4. Поискайте от клавиатурата двe стойности `bool a, b;` . 
...
5. Да се напише програма, която по въведени от клавиатурата цели числа k и x   
